...
class AirPrintMdnsPacket(
    ...
    private val uscansTxtRecords: Map<String, String>,
) {
    ...
    private fun buildResponse(): ByteArray {
        val records = listOf(
            ...
            ResourceRecord.srv(uscansServiceInstance, host, securePort),
            ResourceRecord.txt(uscansServiceInstance, uscansTxtRecords),
